    ...
    try:
        ...
        if rzp_user:
            ...
            log = {
                ...
                "raw": frappe.local.request.rawData,
                ...
                "req_data_str_utf8":client.utility.verify_webhook_signature(str(frappe.local.request.data), webhook_signature, webhook_secret),
