        ...
        f = {
          ...
          bindUnbindEvents: function (a) {
            a && f.bindUnbindEvents(!1),
              ...
              n.changeInput &&
                o !== s &&
                o[a ? "on" : "off"]("click", f.clickHandler),
              n.dragDrop &&
                f.isUploadMode() &&
                n.dragDrop.container.length &&
                (n.dragDrop.container[a ? "on" : "off"](
              ...
              f.isUploadMode() &&
                n.clipboardPaste &&
                $(window)[a ? "on" : "off"]("paste", f.clipboard.paste),
          ...
          clickHandler: function (a) {
            return (
              a.preventDefault(),
              f.clipboard._timer ? void f.clipboard.clean() : void s.click()
            );
          },
          onEvent: function (a) {
            switch (a.type) {
            ...
            n.listeners && $.isFunction(n.listeners[a.type])
              ? n.listeners[a.type].call(s, p)
              : null;
          },
          set: function (a, b) {
            switch (a) {
              ...
              case "feedback":
                b ||
                  ...
                  $(!o.is(":file"))
                    ? o.find(".fileuploader-input-caption span").html(b)
                    : null;
                break;
              case "input":
                var g = f._assets.copyAllAttributes(
                  $('<input type="file">'),
                  s,
                  !0
                );
              ...
              case "listInput":
                n.listInput &&
                  n.listInput.val(null === b ? f.files.list(!0) : b);
            }
          },
          onChange: function (a, b) {
            ...
            if (
              ...
              !f.isDefaultMode() || (f.reset(), 0 != c.length))
            ) {
              if (
                n.beforeSelect &&
                $.isFunction(n.beforeSelect) &&
                0 == n.beforeSelect(c, l, p, o, s)
              )
                return !1;
              for (var d = 0, e = 0; e < c.length; e++) {
                ...
                if (i === !0)
                  ...
                  i[2] ||
                    (f.isDefaultMode() &&
                      (f.set("input", ""), f.reset(), (i[3] = !0)),
                    i[1] ? n.dialogs.alert(i[1]) : null),
                  i[3])
                )
                  break;
              }
          ...
          thumbnails: {
            create: function () {
              ...
              $.isFunction(n.thumbnails.beforeShow)
                ...
                : null;
              var a = $(f._assets.textParse(n.thumbnails.box)).appendTo(
                n.thumbnails.boxAppendTo ? n.thumbnails.boxAppendTo : p
              );
              (l = a.is(n.thumbnails._selectors.list)
                ? a
                : a.find(n.thumbnails._selectors.list)),
                f.isUploadMode() &&
                  n.thumbnails._selectors.start &&
                  l.on("click", n.thumbnails._selectors.start, function (a) {
                ...
                f.isUploadMode() &&
                  ...
                  l.on("click", n.thumbnails._selectors.retry, function (a) {
                    if ((a.preventDefault(), f.locked)) return !1;
                    var b = $(this).closest(n.thumbnails._selectors.item),
                      c = f.files.find(b);
                    c && f.upload.retry(c);
                ...
                n.thumbnails._selectors.remove &&
                  l.on("click", n.thumbnails._selectors.remove, function (a) {
                    if ((a.preventDefault(), f.locked)) return !1;
                    var b = $(this).closest(n.thumbnails._selectors.item),
                      c = f.files.find(b),
                      d = function (a) {
                    ...
                    c &&
                      (c.upload && "successful" != c.upload.status
                        ? f.upload.cancel(c)
            ...
            item: function (a) {
              (a.icon = f.thumbnails.generateFileIcon(a.format, a.extension)),
                ...
                (a.progressBar = f.isUploadMode()
                  ? '<div class="fileuploader-progressbar"><div class="bar"></div></div>'
                  : ""),
                (a.html = $(
                  f._assets.textParse(
                    a.appended && n.thumbnails.item2
                      ? n.thumbnails.item2
                      : n.thumbnails.item,
                    a,
                    !0
                ...
                a.html.addClass(
                  "file-type-" +
                    (a.format ? a.format : "no") +
                    " file-ext-" +
                    (a.extension ? a.extension : "no")
                ),
                ...
                $.isFunction(n.thumbnails.onItemShow)
                  ? n.thumbnails.onItemShow(a, l, p, o, s)
                  : null;
            },
            generateFileIcon: function (a, b) {
              ...
              if (d) {
                ...
                e && (c = c.replace("${class}", " is-bright-color")),
            ...
            renderImage: function (a, b) {
              var c = a.html.find(".fileuploader-item-image"),
                d = function (b) {
                  var d = $(b);
                  d.is("img") &&
                    d.on("load error", function (b) {
                      "error" == b.type && e(),
                        g(),
                        null != n.thumbnails.onImageLoaded &&
                        $.isFunction(n.thumbnails.onImageLoaded)
                          ? n.thumbnails.onImageLoaded(a, l, p, o, s)
                          : null;
                    }),
                    d.is("canvas") &&
                      (null != n.thumbnails.onImageLoaded &&
                    ...
                    c
                      .removeClass(
                        "fileupload-no-thumbnail fileuploader-loading"
                      )
                      .html(d);
                },
                e = function () {
                ...
                g = function () {
                  ...
                  if (a && f._pfrL.indexOf(a) > -1)
                    for (
                      f._pfrL.splice(f._pfrL.indexOf(a), 1);
                      b < f._pfrL.length;
              ...
              if (
                ...
                "image" == a.format &&
                  ...
                  (a.appended || n.thumbnails.startImageRenderer || b))
              ) {
                if (
                  n.thumbnails.synchronImages &&
                  (f._pfrL.indexOf(a) != -1 || b ? null : f._pfrL.push(a),
                  f._pfrL.length > 1 && !b)
                )
                  return;
                  ...
                  i = function (a) {
                    if (n.thumbnails.canvasImage) {
                      var b = document.createElement("canvas"),
                        ...
                        i = new Image();
                      (i.onload = function () {
                        var a = n.thumbnails.canvasImage.height
                            ? n.thumbnails.canvasImage.height
                            : c.height(),
                          j = n.thumbnails.canvasImage.width
                        ...
                        if (
                          ...
                          var t = document.createElement("canvas"),
                            u = t.getContext("2d");
                          (t.width = 0.5 * i.width),
                            (t.height = 0.5 * i.height),
                            (u.fillStyle = "#fff"),
                            u.fillRect(0, 0, t.width, t.height),
                            u.drawImage(i, 0, 0, t.width, t.height),
                            u.drawImage(t, 0, 0, 0.5 * t.width, 0.5 * t.height),
                            h.drawImage(
                              t,
                              p > b.width ? p - b.width : 0,
                              0,
                              0.5 * t.width,
                              0.5 * t.height,
                              0,
                ...
                return void ("string" == typeof a.file
                  ? i({ target: { result: a.file } })
          ...
          upload: {
              ...
              if (a.upload) {
                var c = function (b) {
                    a.html
                      ...
                      .addClass("upload-" + (b || a.upload.status));
                  },
                  d = function () {
                    var b = 0;
                    if (f._pfuL.length > 0)
                      for (
                        ...
                        if (
                          f._itFl.indexOf(f._pfuL[b]) > -1 &&
                          f._pfuL[b].upload &&
                          !f._pfuL[b].upload.$ajax
                        ) {
                ...
                if (n.upload.synchron)
                  if (((a.upload.status = "pending"), a.html && c(), b))
                    ...
                    (f._pfuL.indexOf(a) == -1 ? f._pfuL.push(a) : null,
                    f._pfuL.length > 1)
                  )
                    return;
                if (
                  ...
                  n.upload.beforeSend(a, l, p, o, s) === !1
                )
                  return c(), void d();
                if (
                    ...
                    $.each(f._itFl, function (a, b) {
                      ...
                      c &&
                        ...
                        "function" == typeof n.upload.onComplete
                          ? n.upload.onComplete(l, p, o, s, a, b)
                          : null);
                  }),
                  (a.upload.success = function (b, d, e) {
                    (a.uploaded = !0),
                      delete a.upload,
                      (a.upload = { status: "successful" }),
                      a.html && c(),
                      f.set("listInput", null),
                      null != n.upload.onSuccess &&
                      $.isFunction(n.upload.onSuccess)
                        ? n.upload.onSuccess(b, a, l, p, o, s, d, e)
                        : null;
                  }),
                  (a.upload.error = function (b, d, e) {
                    (a.uploaded = !1),
                      (a.upload.status =
                        "cancelled" == a.upload.status
                          ? a.upload.status
                          : "failed"),
                      delete a.upload.$ajax,
                      a.html && c(),
                      null != n.upload.onError && $.isFunction(n.upload.onError)
                        ? n.upload.onError(a, l, p, o, s, b, d, e)
                        : null;
                  }),
            ...
            cancel: function (a) {
              a &&
                a.upload &&
                ((a.upload.status = "cancelled"),
                a.upload.$ajax ? a.upload.$ajax.abort() : null,
                delete a.upload.$ajax,
                f.files.remove(a));
            },
            retry: function (a) {
              a &&
                ...
                (a.html &&
                  n.thumbnails._selectors.retry &&
                  a.html.find(n.thumbnails._selectors.retry).remove(),
            ...
            progressHandling: function (a, b, c) {
              if (a.lengthComputable) {
                ...
                n.upload.onProgress && $.isFunction(n.upload.onProgress)
                  ? n.upload.onProgress(m, b, l, p, o, s)
                  : null;
              }
            },
          },
          dragDrop: {
            onDragEnter: function (a) {
              clearTimeout(f.dragDrop._timer),
                ...
                $.isFunction(n.dragDrop.onDragEnter)
                  ? n.dragDrop.onDragEnter(a, l, p, o, s)
                  : null;
            },
            onDragLeave: function (a) {
              clearTimeout(f.dragDrop._timer),
                (f.dragDrop._timer = setTimeout(
                  function (a) {
                    return (
                      !!f.dragDrop._dragLeaveCheck(a) &&
                      (n.dragDrop.container.removeClass(
                        "fileuploader-dragging"
                      ),
                      f.set("feedback", null),
                      void (null != n.dragDrop.onDragLeave &&
                      $.isFunction(n.dragDrop.onDragLeave)
                        ? n.dragDrop.onDragLeave(a, l, p, o, s)
                        : null))
                    );
                  },
                  100,
            ...
            onDrop: function (a) {
              clearTimeout(f.dragDrop._timer),
                ...
                a &&
                  ...
                  a.originalEvent.dataTransfer.files.length &&
                  f.onChange(a, a.originalEvent.dataTransfer.files),
                null != n.dragDrop.onDrop && $.isFunction(n.dragDrop.onDrop)
                  ? n.dragDrop.onDrop(a, l, p, o, s)
                  : null;
            },
            _dragLeaveCheck: function (a) {
              var c,
                b = $(a.currentTarget);
              return !(
                !b.is(n.dragDrop.container) &&
                ((c = n.dragDrop.container.find(b)), c.length)
              );
            },
          },
          clipboard: {
            paste: function (a) {
              if (
                ...
                a.originalEvent.clipboardData.items.length
              ) {
                var b = a.originalEvent.clipboardData.items;
                f.clipboard.clean();
                for (var c = 0; c < b.length; c++)
                  if (
                    b[c].type.indexOf("image") !== -1 ||
                    b[c].type.indexOf("text/uri-list") !== -1
                  ) {
                    var d = b[c].getAsFile(),
                      e = new Date(),
                      g = function (a) {
                    ...
                    d &&
                      ...
                      (d.name +=
                        d.type.indexOf("/") != -1
                          ? "." + d.type.split("/")[1].toString().toLowerCase()
                          : ".png"),
                      f.set(
                        "feedback",
                        f._assets.textParse(n.captions.paste, { ms: h / 1e3 })
                      ),
          ...
          files: {
            add: function (a, b) {
              var l,
                ...
                j = c.substr(
                  0,
                  c.length - (c.indexOf(".") != -1 ? i.length + 1 : i.length)
                ),
                k = a.data,
                a = a.file || a;
              return (
            ...
            list: function (a, b, c) {
              var d = [];
              return (
                $.each(f._itFl, function (c, e) {
                  if (!e.upload || e.uploaded) {
                    var g = e;
                    (a || b) &&
                      (g =
                        (g.choosed ? "0:/" : "") +
                        (b && null !== f.files.getItemAttr(e, b)
                          ? f.files.getItemAttr(e, b)
                          : e["string" == typeof e.file ? "file" : "name"])),
                      d.push(g);
                  }
                }),
                (d =
                  n.onListInput && $.isFunction(n.onListInput) && !c
                    ? n.onListInput(f._itFl, n.listInput, l, p, o, s)
                    : d),
            ...
            check: function (a, b, c) {
              ...
              if (
                null != n.limit &&
                c &&
                b.length + f._itFl.length - 1 > n.limit
              )
                return (
                  (d[1] = f._assets.textParse(n.captions.errors.filesLimit)),
                  (d[3] = !0),
                  d
                );
              if (null != n.maxSize && c) {
              ...
              if (null != n.onFilesCheck && $.isFunction(n.onFilesCheck) && c) {
                ...
                if (g === !1) return (d[3] = !0), d;
              }
              if (
                null != n.extensions &&
                $.inArray(a.extension, n.extensions) == -1 &&
                $.inArray(a.type, n.extensions) == -1
              )
                return (
                  (d[1] = f._assets.textParse(n.captions.errors.filesType, a)),
                  d
                );
              if (null != n.fileMaxSize && a.size > 1e6 * n.fileMaxSize)
                return (
                  (d[1] = f._assets.textParse(n.captions.errors.fileSize, a)), d
                );
                ...
                $.each(f._itFl, function (b, c) {
                  if (
                    ...
                    return (
                      ...
                      (a.file.lastModified &&
                        c.file.lastModified &&
                        c.file.lastModified != a.file.lastModified)
                        ? ((d[1] = f._assets.textParse(
              ...
              if (((a = $.isArray(a) ? a : [a]), a.length)) {
                for (var b, c = 0; c < a.length; c++)
                  (b = f._itFl[f.files.add(a[c], "appended")]),
                    n.thumbnails ? f.thumbnails.item(b) : null;
                return (
                  f.set("feedback", null),
                  f.set("listInput", null),
                  n.afterSelect && $.isFunction(n.afterSelect)
              ...
              if (
                ...
                if (
                  (a.html &&
                    ...
                    !b
                      ? n.thumbnails.onItemRemove(a.html, l, p, o, s)
                      : a.html.remove()),
                  a.upload &&
                    a.upload.$ajax &&
                    a.upload.cancel &&
                  ...
                  $.each(f._itFl, function (d, e) {
                    if (
                      a != e &&
                      (a.input == e.input ||
                        (b && a.input.get(0).files.length > 1))
                    )
                      return (c = !1), !1;
                  }),
                    c &&
                      (f.isAddMoreMode() && sl.length > 1
                        ? (sl.splice(sl.indexOf(a.input), 1),
                          a.input.remove(),
                          f.set("nextInput"))
                        : f.set("input", ""));
                }
                f._pfrL.indexOf(a) > -1
                  ...
                  f._pfuL.indexOf(a) > -1
                    ...
                    : null,
                  f._itFl.indexOf(a) > -1
                    ? f._itFl.splice(f._itFl.indexOf(a), 1)
                    : null,
                  (a = null),
                  0 == f._itFl.length ? f.reset() : null,
                  f.set("feedback", null),
                  f.set("listInput", null);
              }
            },
            ...
            clear: function (a) {
              for (var b = 0; b < f._itFl.length; ) {
                var c = f._itFl[b];
                a || !c.appended
                  ? (c.html && (c.html ? f._itFl[b].html.remove() : null),
          ...
          _assets: {
            ...
            copyAllAttributes: function (a, b) {
              return (
                $.each(b.get(0).attributes, function () {
                  "required" != this.name && a.attr(this.name, this.value);
                }),
                b.get(0).FileUploader &&
                  (a.get(0).FileUploader = b.get(0).FileUploader),
                a
              );
            },
              ...
              switch (
                ...
                case "string":
                  text = text.replace(/\$\{(.*?)\}/g, function (match, a) {
                    var a = a.replace(/ /g, ""),
                      r =
                        "undefined" != typeof opts[a] && null != opts[a]
                          ? opts[a]
                          : "";
            ...
            textToColor: function (a) {
              ...
              for (
                var b = 0, c = 0;
                b < a.length;
                c = a.charCodeAt(b++) + ((c << 5) - c)
              );
              for (
                var b = 0, d = "#";
                b < 3;
                d += ("00" + ((c >> (2 * b++)) & 255).toString(16)).slice(-2)
              );
              return d;
            },
            isBrightColor: function (a) {
              var b = function (a) {
                  var b;
                  return a && a.constructor == Array && 3 == a.length
                    ? a
                    : (b = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(
                        a
                      ))
                    ? [parseInt(b[1]), parseInt(b[2]), parseInt(b[3])]
                    : (b = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(
                        a
                      ))
                    ? [
                        2.55 * parseFloat(b[1]),
                    ...
                    : (b = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(
                        a
                      ))
                    ? [
                        parseInt(b[1], 16),
                    ...
                    : (b = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(a))
                    ? [
                        parseInt(b[1] + b[1], 16),
                        parseInt(b[2] + b[2], 16),
                        parseInt(b[3] + b[3], 16),
      ...
      return (
        n.enableApi &&
          s.prop("FileUploader", {
            ...
            remove: function (a) {
              return (
                (a = a.jquery ? f.files.find(a) : a),
                f._itFl.indexOf(a) > -1 && (f.files.remove(a), !0)
              );
            },
            reset: function () {
              return f.reset(!0), !0;
      ...
      captions: {
        ...
        feedback2: function (a) {
          return (
            a.length +
            " " +
            (a.length > 1 ? " files were" : " file was") +
            " chosen"
          );
        },
        ...
        errors: {
          ...
          filesSizeAll:
            "Files that you choosed are too large! Please upload files up to ${maxSize} MB.",
