...
from lms import __user_kyc, user
...
def execute():
    ...
    for kyc in user_kyc_list:
        try:
            ...
            # user_kyc = __user_kyc(entity=kyc.user, pan_no=kyc.pan_no, throw=False)
            ...
            if res_json["banks"]:
                for bank in res_json["banks"]:
                    ...
                    if user_bank_acc_name:
                        frappe.db.sql(
                            """Update `tabUser Bank Account` set
                        is_default='{}',
                        account_type='{}',
                        cancel_cheque_file_name='{}',
                        ifsc='{}',
                        micr='{}',
                        branch='{}',
                        bank='{}',
                        ...
                        address_state='{}',
                        account_number='{}'
                        where name='{}' and parent='{}' and account_number='{}'
                        """.format(
                                bank["defaultBank"] == "Y",
                                bank["accountType"],
