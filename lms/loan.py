...
def loan_unpledge_request(**kwargs):
    try:
        ...
        if loan_margin_shortfall:
            return utils.respondWithFailure(
                status=417,
                message="""OOPS! Dear {}, It seems you have a margin shortfall. You cannot unpledge any of the pledged securities until the margin shortfall is made good. Go to: Margin Shortfall""".format(loan.get_customer().first_name))
