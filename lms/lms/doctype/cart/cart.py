    ...
    def create_loan_application(self):
        ...
        if self.loan_margin_shortfall:
            ...
            if loan_margin_shortfall.status == "Pending":
                ...
                frappe.db.commit()
                msg = "Dear Customer,\nThank you for taking action against the margin shortfall. You can view the 'Action Taken' summary on the dashboard of the app under margin shortfall banner.-Spark Loans"
                receiver_list = list(
                    set(
                        [
