...
frappe.ui.form.on('Concentration Rule', {
	...
	is_single_script_allowed: function(frm) {
		frm.set_df_property("single_script_threshold", "reqd", frm.doc.is_single_script_allowed);
		frm.set_df_property("single_script_threshold_type", "reqd", frm.doc.is_single_script_allowed);
	},
	is_group_script_limited: function(frm) {
		frm.set_df_property("per_script_threshold", "reqd", frm.doc.is_group_script_limited);
		frm.set_df_property("per_script_threshold_type", "reqd", frm.doc.is_group_script_limited);
		frm.set_df_property("group_script_threshold", "reqd", frm.doc.is_group_script_limited);
		frm.set_df_property("group_script_threshold_type", "reqd", frm.doc.is_group_script_limited);
	},
	is_group_script_max_limited: function(frm) {
		frm.set_df_property("group_script_max_limit", "reqd", frm.doc.is_group_script_max_limited);
		frm.set_df_property("group_script_max_limit_type", "reqd", frm.doc.is_group_script_max_limited);
	}
});
