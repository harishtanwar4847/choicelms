        ...
        <tr>
            <td>
                <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                    URGENT NOTICE.<br />
                    <br />
                    An invoke has been triggered in your loan account {{doc.get("loan_margin_shortfall").get("loan")}} due to inaction on your part to mitigate
                    margin shortfall.<br />
                    <br />
                    The lender will invoke required collateral and deposit the proceeds in your loan account to fulfill the
                    shortfall.<br />
                    <br />
