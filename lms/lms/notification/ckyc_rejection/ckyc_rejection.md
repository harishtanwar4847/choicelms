        ...
        <tr>
            <td>
                <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                  Your request for KYC on spark.loans app has been rejected due to mismatch in
                  the details, kindly visit the spark.loans app to reapply for the KYC verification
                  process.<br />
                  <br />
