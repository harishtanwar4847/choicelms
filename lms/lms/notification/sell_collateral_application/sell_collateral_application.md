        ...
        <tr>
          <td>
            <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                {% if doc.get("sell_collateral_application").get("status") == "Approved" %}
                Congratulations! Your sell collateral request has been successfully executed and sale proceeds credited to your loan account.<br />
                <br />
                ...
                <br />
                {% endif %}
                {% if doc.get("sell_collateral_application").get("status") == "Rejected" %}
                Sorry! Your sell collateral request was turned down due to technical reasons.<br />
                <br />
