...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#fff">
  ...
  <tr>
    <td><table class="table1" width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="width:95% !important">
        ...
        <tr>
          <td><strong><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#2c2a2b">Dear full_name,</span></strong></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
            <td>
                <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                  This is to inform you that we have revised Rate of interest in your LAS account no loan_name from old_interest% to new_interest% which shall be effective from wef_date. Please make reference to the attached Interest Change Letter<br />
                  <br />
                  <br />
