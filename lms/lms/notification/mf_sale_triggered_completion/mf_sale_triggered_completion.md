        ...
        <tr>
            <td>
                <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                    Invoke initiated by the lending partner for your loan account {{doc.get("sell_triggered_completion").get("loan")}} is now completed .<br />
                    The invoke proceeds have been credited to your loan account and collateral value updated. 
