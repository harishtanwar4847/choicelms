        ...
        <tr>
          <td>
            <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                Sorry! Your loan application was turned down since the requested loan amount is not in the range of lender's minimum sanction limit (Rs.{{doc.get("minimum_sanctioned_limit")}}) and maximum sanction limit (Rs.{{doc.get("maximum_sanctioned_limit")}}) criteria.<br />
                <br />
                We regret the inconvenience caused.<br />
                <br />
                Please try again with the expected criteria or you can reach to us through 'Contact Us' on the app.<br />
