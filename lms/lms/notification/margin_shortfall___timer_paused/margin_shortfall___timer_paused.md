        ...
        <tr>
            <td>
                <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                    Due to bank holiday, the margin shortfall timer on your loan account {{doc.get("loan_margin_shortfall").get("loan")}} has been paused on {{doc.get("loan_margin_shortfall").get("stop_time")}} and will resume on {{doc.get("loan_margin_shortfall").get("start_time")}}. Please check the app and take an appropriate action.<br />
                    <br />
