...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#fff">
  ...
  <tr>
    <td><table class="table1" width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="width:95% !important">
        ...
        <tr>
          <td><span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">Thank you for joining Spark.loans.<br />
            <br />
            <a href="{{ doc.url }}" style="color:#000"><u>Click here</u></a> to confirm that this is the correct email to reach you.<br />
            <br />
            <strong>Tip:</strong> Add our email address to your contacts to make sure they are never lost or get marked as spam - <a href="mailto:reception@spark.loans" style="color:#000">reception@spark.loans</a></span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
