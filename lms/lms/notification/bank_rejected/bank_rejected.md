        ...
        <tr>
            <td>
                <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:150%; color:#2c2a2b">
                  Your request for linking bank account on spark.loans app has been rejected due
                  to mismatch in the details provided; kindly visit the spark.loans app in order to
                  reapply.<br />
                  <br />
