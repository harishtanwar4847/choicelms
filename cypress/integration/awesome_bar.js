context("Awesome Bar", () => {
  ...
  it("find text in doctype list", () => {
    cy.get("#navbar-search").type("test in todo{downarrow}{enter}", {
      delay: 200,
    });
  ...
  it("navigates to new form", () => {
    cy.get("#navbar-search").type("new blog post{downarrow}{enter}", {
      delay: 200,
    });
  ...
  it("calculates math expressions", () => {
    cy.get("#navbar-search").type("55 + 32{downarrow}{enter}", { delay: 200 });
